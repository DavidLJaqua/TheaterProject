...
//    private ShowList showList;
    ...
    public static final int CLIENT_HAS_ACTIVE_SHOW = 2;
...
//    }
  ...
  //  
    ...
    public static Theater retrieve() {
      try {
        ...
        input.readObject();
  //      CustomerIdServer.retrieve(input); // CustomerIdServer will be the class to create a unique Id when a new customer has been added
        return theater;
  ...
  //      output.writeObject(CustomerIdServer.instance()); // CustomerIdServer will be the class to create a unique Id when a new customer has been added
        return true;
      } catch(IOException ioe) {
        ioe.printStackTrace();
        return false;
