...
public class Customer implements Serializable {
	  ...
	  /*ToDo implement setBalance() : void*/
	  
	  
	  /*Getters, Setters, and toString function*/
	  @Override
	  public String toString() {
		  return "Customer [name=" + name + ", address=" + address + ", phoneNum=" + phoneNum + ", customerId="
				+ customerId + "]";
	  }
	  /*Getters*/
	  ...
	  /*Todo: this dummy main function used as temp driver
	   * to test out correctness of constructor, and
	   * the UniqueId generating getId() of CustomerIdServer class*/
	  public static void main(String[] args) {
		  System.out.printf("To do: testing ");
	  }  
